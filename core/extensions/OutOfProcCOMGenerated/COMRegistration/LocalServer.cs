...
{
    public sealed partial class LocalServer : IDisposable
    {
        ...
        private partial class Ole32
        {
            ...
            public static partial int CoRegisterClassObject(ref Guid guid, [MarshalAs(UnmanagedType.Interface)] object obj, int context, int flags, out int register);
