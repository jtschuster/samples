...
namespace COMRegistration
{
    ...
    public partial interface ITypeInfo
    {
        ...
        void GetTypeComp([MarshalAs(UnmanagedType.Interface)] out object ppTComp);
        ...
        void Invoke([MarshalAs(UnmanagedType.Interface)] object pvInstance, int memid, short wFlags, ref DISPPARAMS pDispParams, IntPtr pVarResult, IntPtr pExcepInfo, out int puArgErr);
        void GetDocumentation(int index, out string strName, out string strDocString, out int dwHelpContext, out string strHelpFile);
        void GetDllEntry(int memid, INVOKEKIND invKind, IntPtr pBstrDllName, IntPtr pBstrName, IntPtr pwOrdinal);
        void GetRefTypeInfo(int hRef, out ITypeInfo ppTI);
        void AddressOfMember(int memid, INVOKEKIND invKind, out IntPtr ppv);
        void CreateInstance([MarshalAs(UnmanagedType.Interface)] object? pUnkOuter, in Guid riid, [MarshalAs(UnmanagedType.Interface)] out object ppvObj);
